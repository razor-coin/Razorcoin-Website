...
<html>
    ...
    <body>
        <div class="wrapper">
            <header>
                <div class="container">
                    <div class="col-xs-12 col-md-5 logo-holder">
                        <div class="logo"><img src="images/logo.png" alt="Razorcoin - Cryptocurrency" width="432" height="75"></div>
					</div>
                    <div class="col-xs-12 col-md-7 top-menu-holder">
                        <nav class="hidden-xs ">
                            <ul>
                                <li class="active">
                                    <a  href="/">Home</a>
                    ...
                    <ul class="slides">
						...
						<li class="slide">
                            ...
                            <div class="flex-caption">
								...
								<h4>Razor breaks the link between the end users and the rest of the network, allowing users to transact without revealing their location..</h4>
								
                                <div class="protect">
									<img src="images/protect-icon.png" alt="Protection">
								</div>
                            </div>
                        </li>
                        <li class="slide">
                            ...
                            <div class="flex-caption">
                                ...
                                <h4>Razor utilizes the TOR network, an open-source utility trusted by millions to help protect their privacy.</h4>
                                <div class="tor"><img src="images/small-tor.png" alt="Tor Project "></div>
                            </div>
                        </li>
                        <li class="slide">
                            <div class="image">
					...
					<div class="col-md-6">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<a href="http://www.reddit.com/r/razorcoin">/r/razorcoin</a>
								</p>
		...
		<section id="development" class="section" data-background-color="#DDD"  >
			<div id="row"> 
				<div class="container">
					<div class="col-md-12">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="col-md-6">
									...
									<p>An Analysis of Anonymity in Bitcoin Using P2P Network Traffic:</p>
									<p>
								...
								<div class="col-md-6">
									...
									<p>The Razor whitepaper and solution to the previous whitepaper:</p>
									<p>
					...
					<div class="col-md-5">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<p>
									<a href="https://twitter.com/TheRazorCoin">@TheRazorCoin</a>
								</p>
							</div>
						</div>
					</div>
